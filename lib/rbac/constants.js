...
export const P = /** @type {const} */ ({
  ...
  /** Enrolled learners only (registrar desk) — not full user directory. */
  STUDENTS_REGISTRY_VIEW: 'management.students.registry.view',
  ...
  ADMISSIONS_MANUAL_APPLICATION: 'admissions.application.manual_record',
