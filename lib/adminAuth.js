...
/** Student identities are issued here only (not delegated to admissions/finance personas). */
export function isSystemAdministratorRole(roleSlug) {
  const slug = normalizeRoleSlug(roleSlug)
  return slug === ROLES.ADMIN || slug === ROLES.SUPER_ADMIN
}
